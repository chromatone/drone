...
<template lang="pug">
.flex.flex-col.items-stretch.transition-all.duration-500.ease-out.select-none.rounded-3xl.shadow-xl.border-8.p-1.w-full.h-full(
...
body {
  @apply flex items-stretch justify-stretch h-screen;
